...
export default async function CoachingMilitaryPage({
  params,
}: {
  ...
  const course = courseDetails.find((c) => c.id === "coaching-military");
  const card = courseCards.find((c) => c.id === "coaching-military");
