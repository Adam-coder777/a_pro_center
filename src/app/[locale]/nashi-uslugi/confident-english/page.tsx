...
export default async function ConfidentEnglishPage({
  params,
}: {
  ...
  const course = courseDetails.find((c) => c.id === "confident-english");
  const card = courseCards.find((c) => c.id === "confident-english");
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                {course.links.map((link, idx) => (
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-[#22543d] px-6 py-3 text-base font-semibold text-white shadow-lg transition hover:bg-[#1b3e32] hover:shadow-xl"
                  >
                    {link.label}
