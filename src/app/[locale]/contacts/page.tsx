            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-3 mt-2 overflow-x-auto whitespace-nowrap pb-2 justify-start">
                  ...
                  <a href="https://wa.me/+77781309977?text=Здравствуй%20те!" target="_blank" rel="noopener noreferrer" className="bg-[#fbbf24]/30 hover:bg-[#fbbf24]/60 p-3 rounded-xl transition-all flex items-center gap-2 text-[#22543d] hover:text-white font-semibold border border-[#fbbf24]">
